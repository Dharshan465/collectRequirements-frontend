...
@Component({
  selector: 'app-ld-new-request',
  imports: [FormsModule,CommonModule, UserSelection],
  templateUrl: './ld-new-request.html',
  styleUrl: './ld-new-request.css',
})
export class LdNewRequest {

  
  newRequest: CreateRequest = {
    requestorId: this.ldUserId,
    justification: '',
    groupRequest: false,
    tanNumber: '',
    curriculumLink: '',
...
get ldUserId(): number {
    ...
    const userIdIndex = urlSegments.indexOf('ld') + 1;
